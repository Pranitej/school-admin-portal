...
import AddChildNotes from "./AddChildNotes";
import ChildReservations from "./ChildReservations";
import ChildVaccines from "./ChildVaccines";
import AdminNotes from "./AdminNotes";
import ChildRestrictions from "./ChildRestrictions";

export default function ShowChild({ familyObj, addChildCounter }) {
                              ...
                              <tr className="text-center">
                                <th colSpan={2}>
                                  <img
                                    ...
                                    onClick={() => handleEditPic(childData.id)}
                                    id="editChildImage"
                                  />
                                  {editpicId && (
                                    <div>
