...
export default function ChildDocuments({ childId }) {
  ...
  useEffect(() => getAllChildDocuments(), [childId]);
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div className="modal-content">
            ...
            <div className="modal-header">
              <p className="heading lead">Child Documents</p>
        ...
        {childId && (
          <AddChildDocuments
            childId={childId}
            getAllChildDocuments={getAllChildDocuments}
          />
        )}
